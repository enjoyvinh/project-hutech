...
var commonModule = angular.module('commonModule', ['paragonApp', 'dialogs.main']);
...
commonModule.controller('commonCtrl', function($scope, $rootScope, $http, $window, $filter, dialogs) {
