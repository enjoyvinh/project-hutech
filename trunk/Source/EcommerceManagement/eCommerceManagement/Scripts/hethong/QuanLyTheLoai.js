...
'use strict';
var QuanLyTheLoaiModule = angular.module('QuanLyTheLoaiModule', [
    'commonModule', 'paragonApp', 'ui.bootstrap',
    'dialogs.main','QuanLyHeaderModule', 'QuanLyMenuModule']);


QuanLyTheLoaiModule.factory('QuanLyTheLoaiModel', ['BaseModel', '$rootScope',
...
QuanLyTheLoaiModule.controller('QuanLyTheLoaiControl', function ($rootScope,
    $scope, $modal, $http, $window, $log, dialogs, QuanLyTheLoaiModel) {
    $scope.model = QuanLyTheLoaiModel;
  
    sessionStorage.removeItem("MATHELOAI");
    ...
    $scope.getDanhSachTheLoai = function (param) {
      ...
      $rootScope.$broadcast('doPost', {
        ...
        callback : function(result) {
          ...
          $scope.model.form.list = result.dsTheLoai;
