        ...
        $rootScope.$broadcast('doPost', {
            ...
            callback: function (result) {
                if (!ValidateUtil.isValidTextEmpty(result.SUCCESS)) {
                    ...
                    //$scope.model.form.danhgia.phantramtonggiatritoansan = result.tongluotdanhgiabinhluan;
                    //$scope.model.form.danhgia.tonggiatritoansan = result.tongluotdanhgiabinhluan;
                    //$scope.model.form.danhgia.phantramkhoiluonggiaodich = result.tongluotdanhgiabinhluan;
                    //$scope.model.form.danhgia.khoiluonggiaodich = result.tongluotdanhgiabinhluan;
                    //$scope.model.form.danhgia.phantramtonggiatrigiaodich = result.tongluotdanhgiabinhluan;
                    //$scope.model.form.danhgia.tonggiatrigiaodich = result.tongluotdanhgiabinhluan;
                    //$scope.model.form.danhgia.phantram = result.tongluotdanhgiabinhluan;
                    //$scope.model.form.danhgia.tonggiatri = result.tongluotdanhgiabinhluan;

                    $scope.model.form.danhgia.phantramtoansan = 15;
                    $scope.model.form.danhgia.tonggiatritoansan = 9998765423214;
                    $scope.model.form.danhgia.phantramkhoiluong = -5;
                    $scope.model.form.danhgia.khoiluonggiaodich = 68752401;
                    $scope.model.form.danhgia.phantramtonggiatri = 0;
                    $scope.model.form.danhgia.tonggiatrigiaodich = 85022156156;
                    $scope.model.form.danhgia.phantramdoanhthu = $scope.model.form.danhgia.phantramtonggiatri * 0.03;
                    $scope.model.form.danhgia.tongdoanhthu = $scope.model.form.danhgia.tonggiatrigiaodich * 0.03;
