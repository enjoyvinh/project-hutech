...
'use strict';
var CapNhatNhanVienModule = angular.module('CapNhatNhanVienModule', [
    'commonModule', 'paragonApp', 'ui.bootstrap',
    'dialogs.main', 'QuanLyHeaderModule', 'QuanLyMenuModule']);


CapNhatNhanVienModule.factory('CapNhatNhanVienModel', ['BaseModel', '$rootScope',
...
CapNhatNhanVienModule.controller('CapNhatNhanVienControl', function ($rootScope,
    $scope, $modal, $http, $window, $log, dialogs, CapNhatNhanVienModel) {
    $scope.model = CapNhatNhanVienModel;
