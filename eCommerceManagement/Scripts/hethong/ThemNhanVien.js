...
'use strict';
var ThemNhanVienModule = angular.module('ThemNhanVienModule', [
    'commonModule', 'paragonApp', 'ui.bootstrap',
    'dialogs.main', 'QuanLyHeaderModule', 'QuanLyMenuModule']);


ThemNhanVienModule.factory('ThemNhanVienModel', ['BaseModel', '$rootScope',
...
ThemNhanVienModule.controller('ThemNhanVienControl', function ($rootScope,
    $scope, $modal, $http, $window, $log, dialogs, ThemNhanVienModel) {
    $scope.model = ThemNhanVienModel;
